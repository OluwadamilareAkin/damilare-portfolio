...
const Home = ({ portfolio, language, setLanguage }) => {
  ...
  // const [__, setTitle] = useState([]);
  // const [___, setId] = useState([]);
  // const [____, setCount] = useState(0);
  ...
  return (
    <>
      ...
      <div className="mb-5">
        <div className="" style={{ color: "#171717" }}>
          {language !== "de" ? (
            <div>
                ...
                <div className="project-maxwidth text-center">
                  ...
                  <div className="d-flex justify-content-center">
                    <h1 className="intro-font">
                      I’m <span style={{ color: "#100BF5" }}>Vincent</span>,
                      UI/UX Designer
                    </h1>
                  </div>
                </div>
              ...
              <div className="d-md-flex align-items-center">
                <div className="w-100" style={{paddingLeft:"2rem"}}>
                  <h5 className="fs-5 fs-md-4 fs-md-3 fs-sm-2">
                    ...
                    now. I'm passionate about the transformative power of
                    creative designs and thrive on crafting exceptional user
                    experiences. I’m currently writing my Master's thesis in
                    Media Design at the University of Europe for Applied
                    Sciences, Berlin. I currently volunteer as a UI/UX working
                    student at TechLabs. Beyond design, I find fulfilment in
                    volunteering for eco-friendly causes.
                    <br />
                    <br />
                    In essence, my philosophy is encapsulated by the mantra,
                    "Everything starts with an idea, and in the end, the
                    satisfaction of end users is paramount."
                  </h5>
                  <button
                ...
                <div className="w-100 d-flex justify-content-center ceo_bg">
                  ...
                  <img
                    src={ceoIcon}
                    alt="icons img"
                    className=" w-75 ceo-icon"
                  />
                  <img
                    src={ceoArrow}
                    alt="icons img"
                    className="w-25 ceo-arrow"
                  />
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="d-flex justify-content-center">
                <div className="project-maxwidth-germany text-center">
                  ...
                  <div className="d-flex justify-content-center">
                    <h1 className="intro-font">
                      Ich bin <span style={{ color: "#100BF5" }}>Vincent</span>,
                      UI/ UX-Designer
                    </h1>
                  </div>
                </div>
              ...
              <div className="w-100" style={{paddingLeft:"2rem"}}>
                  <h5 className="fs-5">
                    ...
                    Branche tätig ist. Ich bin begeistert von der
                    transformativen Kraft kreativer Designs und liebe es,
                    außergewöhnliche Nutzererlebnisse zu gestalten. Derzeit
                    schreibe ich meine Masterarbeit in Mediendesign an der
                    Europäischen Fachhochschule Berlin. Derzeit arbeite ich
                    ehrenamtlich als UI/UX-Werkstudentin bei TechLabs. Neben dem
                    Design finde ich Erfüllung im ehrenamtlichen Engagement für
                    umweltfreundliche Zwecke. <br />
                    <br />
                    <br />
                    Meine Philosophie lässt sich im Wesentlichen mit dem Mantra
                    zusammenfassen: "Alles beginnt mit einer Idee, und am Ende
                    steht die Zufriedenheit der Endnutzer an erster Stelle."
                  </h5>
                  <button
                    onClick={downloadResume}
                    className="btn my-btn py-2 px-3 mt-3"
      ...
      <div className="bg-white project-padding">
        ...
        <div className="">
          <img src={projectImage} alt="Project" className="w-100" />
        </div>
      </div>
      ...
      <div className=" project-padding bg-blue-light p-2 p-sm-3 p-lg-5">
        <h4 className="fw-bold mb-4">
          {language === "de" ? "Meine Dienstleistungen" : "My Services"}
        </h4>
